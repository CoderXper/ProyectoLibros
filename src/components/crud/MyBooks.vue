<template>
    <div class="container d-flex">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table-lg mt-3">
                            ...
                            <thead>
                                ...
                                <th class="sortable">Rango Edad</th>
                                <th class="sortable">Pag.</th>
                            ...
                            <tbody>
                                ...
                                <td class="text-nowrap align-middle">Cien Años Soledad </td>
                                <td class="text-nowrap align-middle"><span>Gabriel Garcia</span></td>
                                <td class="text-center align-middle"> >15</td>
                                <td class="text-center align-middle"> 350</td>
                ...
                <div class="col-12 col-lg-3 mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center px-xl-3">
                            <button class="btn btn-success btn-block" type="button" data-toggle="modal" data-target="#user-form-modal">Crear</button>
                            <button class="btn btn-success btn-block" type="button" data-toggle="modal" data-target="#user-form-modal">Eliminar</button>
                            <button class="btn btn-success btn-block" type="button" data-toggle="modal" data-target="#user-form-modal">Actualizar</button>
                        </div>
                        <!-- <hr class="my-3">
        ...
        <!-- <div class="container d-flex justify-content-center align-items flex-end mt-3">
            <b-button-group>
            <b-button variant="success">Crear</b-button>
            <b-button variant="info">Actualizar</b-button>
